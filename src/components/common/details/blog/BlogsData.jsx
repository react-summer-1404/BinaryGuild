...
const BlogsData = ({
  ...
  return (
    <div>
      ...
      <div className="w-11/12 m-auto">
        <img src={currentImageAddressTumb} className="w-full rounded-3xl" />
      </div>
      <div className="w-11/12 flex flex-wrap m-auto">
        <div className="w-full flex justify-between ">
          ...
          <div className="w-1/3 flex flex-nowrap">
            ...
            <Like />
            <p className="font-persian">{newsLike}</p>
            <DisLike />
            <p className="font-persian">{newsDissLike}</p>
          </div>
        </div>
        <div className="w-full flex justify-between ">
        ...
        <div className="w-full flex justify-around ">
          ...
          <div>
            <p className="font-bold w-full text-textBlue2 text-start"></p>
            <View2 />
            <p className="font-persian text-text">{newsView}</p>
          </div>
          <div>
            <p className="font-bold w-full text-textBlue2 text-start"></p>
            <Calender />
