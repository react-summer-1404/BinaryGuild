  ...
  return (
    <div className='flex flex-col h-full justify-between'>
        ...
        <div className=' text-start text-black'>
          <h2 className='text-text font-bold w-full text-3xl'> {t("AuthTitle")} </h2>
          <p className='text-muted mt-4 w-full mb-4 m-l-0 m-r-0 text-xl font-bold'>{t("AuthDescription")} </p>
        </div>
