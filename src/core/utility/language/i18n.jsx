  ...
  resources: {
    fa: {
      translation: {
        ...
        completedPro: "پروفایل تکمیل شده",
        confirmedComments: "رزرو های تایید شده",
        notConfirmedComments: "رزرو های تایید نشده",
        BarCHartTitle: "دسته بندی کاربران بر اساس نقش",
        DoughnutChart10Percentage: "درصد تکمیل پروفایل کاربران (بالای 10 درصد)",
        DoughnutChart40Percentage: "درصد تکمیل پروفایل کاربران (بالای 40 درصد)",
        countMore10: "تعداد بالای 10 درصد",
        countLess10: "تعداد پایین 10 درصد",
        countMore40: "تعداد بالای 40 درصد",
        countLess40: "تعداد پایین 40 درصد",
        CoursePercentage: " درصد دوره های فعال",
        activeCourseCount: "تعداد فعال",
        inActiveCourseCount: "تعداد غیرفعال",
        usersPercentage: " درصد کاربران فعال",
        activeUserText: "کاربران فعال هستند",
        student: "دانش آموز",
        teacher: "استاد",
        superAdmin: "ادمین اصلی",
        admin: "ادمین",
        CongratsText: " عزیز تبریک، مجموع مبلغ کل دوره ها به ",
        CongratsText2: "تومان رسید",
        addUserTitle:"لطفا اطلاعات کاربر را وارد کنید",
        gmail:"ایمیل",
        phoneNumber:"شماره تلفن",
        password:"رمز عبور",
        confirmRole:"نقش کاربر",
        confirm:"تایید",
        cancel:"لغو",
    ...
    en: {
      translation: {
        ...
        completedPro: "completed Profile",
        confirmedComments: "confirmed Comments",
        notConfirmedComments: "not Confirmed Comments",
        BarCHartTitle: "User categorization by role",
        DoughnutChart10Percentage:
          "Profile completion percentage of users (above 10%)",
        DoughnutChart40Percentage:
          "Profile completion percentage of users (above 40%)",
        countMore10: "Number above 10%",
        countLess10: "Number below 10%",
        countMore40: "Number above 40%",
        countLess40: "Number below 40%",
        CoursePercentage: "Percentage of active courses",
        activeCourseCount: "Number of active courses",
        inActiveCourseCount: "Number of inactive courses",
        usersPercentage: "Percentage of active users",
        activeUserText: " of users are active",
        student: "student",
        teacher: "teacher",
        superAdmin: "super admin",
        admin: "admin",
        CongratsText: " congragulation, your total course payments reach to ",
        CongratsText2:"Tooman",
        addUserTitle:"pleaser enter user's info",
        gmail:"gmail",
        phoneNumber:"phone Number ",
        password:"password ",
        confirmRole:"confirm the role ",
        confirm:"confirm",
        cancel:"cancel",
