  ...
  resources: {
    fa: {
      translation: {
        ...
        SuccessfullySaved: "رمز عبور شما با موفقیت ذخیره شد",
        ProblemSaving: "مشکلی در ذخیره سازی رمز عبور شما پیش امده",
        WriteYourEmail: "ایمیل خود را بنویسید",
        WriteYourUserNAme: "نام کاربری تلگرام خود را بنویسید",
        WriteYourEmail2: "ایمیل یا شماره تلفن خود را بنویسید",
        WriteCode: "کدی که ارسال شد را بنویسید",
        Code: "کد",
        WriteEmail2: "ایمیل",
        ...
        LearnNewSkills:
          "یادگیری مهارت های جدید در زمانی که و جایی که تو دوست داری",
    ...
    en: {
      translation: {
        ...
        SuccessfullySaved: "Your password was successfully saved",
        ProblemSaving: "There was a problem saving your password",
        WriteYourEmail: "Write your email",
        WriteYourUserNAme: "Write your Telegram username",
        WriteYourEmail2: "Write your email or your phone number",
        WriteCode: "Write the code that was sent",
        Code: "Code",
        WriteEmail2: "Email or phone number",
        WriteUserName: "Telegram username",
        GetRobotLink:
        ...
        Description1:
          "Expert teachers provide effective guidance to students with their knowledge and experience",
        TeachersAndCourses2: "Effective courses",
        Description2:
          "Effective courses significantly improve learners' capabilities.",
        TeachersAndCourses3: "Get a certificate",
        Description3:
          "Obtaining a certification indicates a person's ability and expertise in a specific field.",
