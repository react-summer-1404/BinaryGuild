  ...
  resources: {
    fa: {
      translation: {
        ...
        reserved: "دوره های رزرو شده",
        otherInfo: "سایر اطلاعات کاربر",
        nameOfCourse: "نام دوره",
        courseDes: "توضیحات دوره",
        lastUpdate: "تاریخ آخرین بروزرسانی",
        courseTableTitle: "دوره های تایید شده",
        reserveCourseTableTitle: "دوره های رزرو شده",
        reservedDate: "تاریخ رزرو",
        isReserved: "رزرو شده",
        isNotReserved: "رزرو نشده",
        noCourse: "هیچ دوره ای برای این کاربر یافت نشد",
        noReserveCourse: "هیچ دوره ی رزرو شده ای برای این کاربر یافت نشد",
        acceptedComments: "کامنت های تایید شده",
        notAcceptedComments: "کامنت های تایید نشده",
        commentName: "عنوان کامنت",
        commentText: "متن کامنت",
        accepted: "تایید شده",
        notAccepted: "تایید نشده",
        otherInfoOfUser: "سایر اطلاعات کاربر",
        aboutUser: "درباره ی کاربر",
        birthDate: "تاریخ تولد",
        creatingAccountDate: "تاریخ ایجاد حساب کاربری",
        twoStepVerify: "اعتبارسنجی دو مرحله ای",
        recoveryEmail: "ایمیل بازیابی",
        getEventMessage: "دریافت پیام رویداد ها",
    ...
    en: {
      translation: {
        ...
        noCourse: "There is no course for this user",
        noReserveCourse: "There is no reserved course for this user",
        acceptedComments: "accepted Comments",
        notAcceptedComments: "not accepted Comments",
        commentName: "title",
        commentText: "describe",
        accepted: "accepted",
        notAccepted: "not accepted",
        otherInfoOfUser: "user's other information",
        aboutUser: "about user",
        birthDate: "birth date",
        creatingAccountDate: "creating account date",
