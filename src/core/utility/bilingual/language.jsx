  ...
  resources: {
    fa: {
      translation: {
        ...
        RegisterCaption:"لطفا شماره همراه خود را وارد کنید تا کد تایید برای شما ارسال شود",
        ...
        GetCodeCaption:"لطفا کد ارسال شده به شماره همراه {{phoneNumber}} را وارد کنید",
        ...
        LoginCaption:'لطفا شماره همراه یا ایمیل و رمزعبور خود را برای ورود به حساب کاربری را وارد کنید',
    ...
    en: {
      ...
      RegisterCaption: "Please enter your mobile number to receive verification code",
      ...
      LoginCaption: 'Please enter your mobile number or email and password to login',
      ...
      ForgetPassCaption: "If you forgot your password, enter your email to receive password reset link",
