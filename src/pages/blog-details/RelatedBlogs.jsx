...
const RelatedBlogs = ({ newsCatregoryId }) => {
  ...
  const formatInsertDate = moment(newsCatregoryId.insertDate).format(
    "jYYYY/jMM/jDD"
  );
  ...
  const visibleRelatedBlogs = relatedBlogs.slice(0, 3);
  ...
  return (
    <div className=" w-full mb-14 mt-40   max-[768px]:mt-320 max-[500px]:mt-320 ">
      ...
      <div className=" h-95 overflow-hidden w-full grid grid-cols-4 gap-4 mt-6 max-[1200px]:grid-cols-3 max-[1000px]:flex max-[1000px]:overflow-x-scroll max-[1000px]:scrollbar-hide   ">
        {visibleRelatedBlogs.length > 0 ? (
          visibleRelatedBlogs.map((items) => (
            <div
              key={items.id}
            ...
            >
              <div className="relative gap-2 flex ">
                <img
                  ...
                  src={items.currentImageAddressTumb || []}
                  onError={(e) => {
                    e.target.src =
              ...
              <div className="  ">
                ...
                <div className="flex justify-between mt-3">
                  <div className="flex gap-2">
                    ...
                    <img
                      src="../../../src/assets/icons/calendar-03.png"
                      alt=""
                    />
                    <p></p>
                  </div>
          ...
          <p className="relative right-50 flex items-center max-[768px]:mt-10 justify-center ">
            {" "}
            {t("NoRelatedCourse")}
          </p>
        )}
